function string_traveling_wave_sim()
    ...
    Uf_func = @(t) triangle_pulse(t, pulse_width, pulse_height);
    dUfdt_func = @(t) triangle_pulse_derivative(t, pulse_width, pulse_height);
    ...
    hMarker = plot(0, 0, 'ro', 'MarkerSize', 10, 'LineWidth', 2); 
    ...
    for k = 1:length(tlist)
        ...
        marker_x = string_length - c*(tlist(k) - 1);
